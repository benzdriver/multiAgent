...
class TestClarifierIntegration(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_clarifier_with_requirement_analyzer(self):
        ...
        with patch.object(RequirementAnalyzer, 'analyze_requirements') as mock_analyze:
            ...
            with patch.object(RequirementAnalyzer, 'analyze_granular_modules') as mock_analyze_granular:
    ...
    async def test_end_to_end_workflow(self):
        ...
        mock_requirement_analyzer.analyze_granular_modules.return_value = [
            {
                "module_name": "登录页面",
                "layer": "表现层",
                "type": "页面",
        ...
        mock_architecture_reasoner.check_all_issues.return_value = {
            "circular_dependencies": [],
            "naming_inconsistencies": [],
            "layer_violations": [],
            "responsibility_overlaps": [],
        ...
        with patch.object(self.clarifier, 'run_llm') as mock_run_llm:
            ...
            with patch.object(self.clarifier, '_read_all_markdown_files') as mock_read:
                ...
                with patch('builtins.open', mock_open()) as mock_file:
                    ...
                    mock_requirement_analyzer.analyze_granular_modules.assert_called_once()
                    mock_index_generator.generate_indices.assert_called_once()
                    mock_architecture_reasoner.check_all_issues.assert_called()
